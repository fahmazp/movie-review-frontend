...
import { Menu, X, House, Users, Video  } from 'lucide-react'
...
const navigation = [
  ...
  { name: 'Admin Profile', to: '/admin/profile', icon: Video },
]
    ...
    <>
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-60 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gradient-to-b from-zinc-950 via-gray-900 to-black px-6">
            <div className="flex h-16 shrink-0 items-center">
              <img
                alt="Honey popcorn"
                src={logo}
